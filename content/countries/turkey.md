...
flag: "🇹🇷"
region: "Asia/Europe"
policy_summary: "Turkish citizens are NOT eligible for 30-day visa-free entry, but CAN use the 240-hour transit program. For direct visits, apply for an L tourist visa."
last_verified: "2026-06-04"
source_url: "https://en.nia.gov.cn/"
source_label: "NIA China"
requirements:
  - "Passport valid for at least 3 months"
  - "Confirmed onward ticket to a THIRD country (not back to Turkey)"
...
## Turkey → China: Entry Requirements 2026



**Short version:** Turkey citizens are NOT on China's 30-day visa-free list, but CAN use the 240-hour (10-day) transit visa-free program if flying through China to a third country.

**The trick:** Book a multi-city itinerary: Turkey → Beijing (stay 5 days) → Tokyo/Seoul/Bangkok (onward). Your transit visa-free is valid for 10 days.
